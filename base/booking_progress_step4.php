<div class="row bs-wizard" style="border-bottom:0;">
    ...
    <div class="col-xs-3 bs-wizard-step complete">
        ...
        <div class="bs-wizard-info text-center hidden-xs">
            <a href="#"><?= __($settings['booking_steps__step_bullets__text_under_2']) ?></a>
        </div>
        <div class="bs-wizard-info text-center visible-xs">
            <a href="#"><?= str_replace(' ', '<br>', __($settings['booking_steps__step_bullets__text_under_2'])) ?></a>
        </div>
    </div>
    ...
    <div class="col-xs-3 bs-wizard-step complete">
        ...
        <div class="bs-wizard-info text-center visible-xs">
            <a href="#">
                <?= str_replace(' ', '<br>', ($settings['booking_steps__step_bullets__text_under_3'])) ?></a>
        </div>
    </div>
